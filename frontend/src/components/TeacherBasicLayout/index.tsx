...
import { Breadcrumb, Layout, Menu, Modal, Popconfirm } from 'antd';
      ...
      >
        ...
        <div className={styles.header}>
          <Menu
            ...
            style={{ background: '#9d3230', color: '#fff', fontSize: 18 }}
            mode="horizontal"
            selectedKeys={active}
          ...
          >
            <Menu.Item key="/teacher/home">
              <Link
                style={{
                  color: active.includes('/teacher/home') ? '#ff9500' : '#fff',
                }}
                to="/teacher/home"
              >
                我的课程
            ...
            <Menu.Item key="teacher/test">
              <Link
                style={{
                  color: active.includes('/teacher/test') ? '#ff9500' : '#fff',
                }}
                to="/teacher/test"
              >
                测验结果
          ...
          <div className={styles.right}>
            <span className={styles.nick}>
              <img
                width={40}
                onClick={() => history.push('/teacher/info')}
                height={40}
